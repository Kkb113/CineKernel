...
CPU and GPU WASM paths share core renderer and selected prepasses with native export. End-to-end parity remains conditional because the browser resolves video and audio differently, preview may skip requested frames, and Canvas2D is intentionally incomplete and approximate.

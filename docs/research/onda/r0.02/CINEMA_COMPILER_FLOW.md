...
Cinema validates and resolves timing, roles, registry entries, choreography, transitions, placement, themes, mattes, effects, and selected 3D wrappers. It emits a React composition. Most authoring labels and named intent are consumed during this stage rather than represented in Scene.
